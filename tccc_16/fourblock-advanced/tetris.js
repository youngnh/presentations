goog.provide('fourblock');

goog.require('fourblock.fn');
goog.require('fourblock.rand');

//global variables section
//
var gameloop = false;       //will hold closure to call at intervals
var endgame;                //will hold id of interval, so it can be cleared

var seed = new Date().getTime(); // piece sequence seed
var random = new Random(seed);   //seeded random number generator


var board_height = 18;      //height in grid units of board
var board_width = 10;       //width in grid units of board
var prev_height = 4;        //height in grid units of preview pane
var prev_width = 6;         //width in grid units of preview pane

var glbl_width = 20;        //width of block
var border_width = 3;       //width of border around board
var board_top = 40;         //top offset of board
var board_left = 40;        //left offset of board
var prev_top = 100;          //top offset of preview box
var prev_left = 280;        //left offset of preview box

var level = 0;              //keeps track of the player's level
var lines = 0;              //number of lines a player has cleared
var level_timing = [2, 4, 6, 8, 10, 12, 14, 16, 18, 32, 64];  //number of times per second a block falls

var glbl_board = false;     //global board variable
var current_piece = false;  //user-manipulable currently-falling piece
var next_piece = false;     //the next piece
...
var current_keymap = arrowkeymap; // default keymap

var SQUARE = 0;             //piece types
var TEE = 1;
var STRAIGHT = 2;
var RZEE = 3;
var LZEE = 4;
var RELL = 5;
var LELL = 6;
var piece_colors = ["yellow", "purple", "lightblue", "green", "red", "orange", "blue"];
var init_positions = [         //intial positions of blocks, with center block first
                  [[5,17], //square - 0
                   [6,17],
                   [5,16],
                   [6,16]],
...
var prev_positions = [         //initial positions of preview pieces
                  [[1,2],  //square - 0
                   [2,2],
                   [1,1],
                   [2,1]],
...
goog.exportSymbol('startgame', startgame);
